...
def get_builders():
    ...
    return [
        ...
        make_builder('windows-vc17-32', ['binary1248-windows'], 'NMake Makefiles JOM', paths.vc17path, 'x86', True, True),
        make_builder('windows-vc17-64', ['binary1248-windows'], 'NMake Makefiles JOM', paths.vc17path, 'amd64', True, True),
