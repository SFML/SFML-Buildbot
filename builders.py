...
def get_builders():
    ...
    return [
        ...
        make_builder('windows-gcc-1420-mingw-32', ['binary1248-windows', 'expl0it3r-windows'],               'MinGW Makefiles',     paths.gcc1420mingw32path, '',            '',   '',                            '',                            True,    True,  True,  True,   True ),
        make_builder('windows-gcc-1420-mingw-64', ['binary1248-windows', 'expl0it3r-windows'],               'MinGW Makefiles',     paths.gcc1420mingw64path, '',            '',   '',                            '',                            True,    True,  True,  True,   True ),
